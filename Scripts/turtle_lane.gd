...
@export var turtle_sections_lengths = [4,3,2]
...
func _ready() -> void:
	var index = 0
	var starting_position_x = -movement_x_limit + turtle_sections_lengths[0] * HALF_TURTLE_SIZE * -movement_direction
	
	for section_length in turtle_sections_lengths:
